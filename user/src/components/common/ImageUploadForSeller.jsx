        ...
        >
            {value ? (
                <div className="relative">
                    <img src={value || "/placeholder.svg"} alt={label} className={`w-full ${height} object-cover rounded-lg`} />
                ...
                <div className={`flex flex-col items-center justify-center ${height}`}>
                    {isUploading ? (
                        ...
                        <>
                            ...
                            <span className="text-xs text-gray-400 mt-1">Tối đa {maxSize}MB</span>
                        </>
                    )}
                </div>
            )}
